...
const selectedItemCount = ref<number | null>(null);

const openDialog = (item: Item, count: number) => {
...
<template>
  <div class="page">
    ...
    <template v-if="selectedItem != null && selectedItemCount != null">
      <ModalDialog
        v-if="isModalOpen"
        :item="selectedItem"
